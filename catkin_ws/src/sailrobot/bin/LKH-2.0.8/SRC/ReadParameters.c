 ...
 * the dad of the node in the minimum spanning tree (0, if the node has no
 * dad), the number of candidate edges emanating from the node, followed by
 * the candidate edges.
 ...
 * the number of edges.
 * Each of the following lines contains the number of the two end nodes of an
